...
<head>
    ...
    <title>About great vision college</title>
...
<body>
        ...
        <div class="container d-flex align-items-center">
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li><a class="active" href="aboutt.php">About</a></li>
    ...
    <main id="main">
        ...
        <div class="breadcrumbs" data-aos="fade-in">
            <div class="container">
                <h2>About Us</h2>
                <h4 style="font-family: 'Times New Roman', Times, serif;"> Great Vision College, situated in the vibrant city of Wolkite, is a distinguished institution committed to providing a transformative educational experience. Nestled in the heart of Wolkite, our college is dedicated to nurturing intellectual
                    curiosity, fostering innovation, and shaping well-rounded individuals. With a focus on academic excellence, our faculty, comprised of seasoned educators and industry experts, strives to empower students with the knowledge and skills
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
                        <img src="assets/img/greatbuilding.jpg" class="img-fluid" alt="">
                    </div>
                    <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
                        ...
                        <ul>
                            ...
                            <li><i class="bi bi-check-circle"></i> Wolkite City's vibrant culture and the college's unwavering commitment to holistic education create a unique synergy, allowing students to explore their passions and unlock their full potential.
                                .
                            </li>
                            <li><i class="bi bi-check-circle"></i>fostering innovation, and shaping well-rounded individuals. With a focus on academic excellence, our faculty, comprised of seasoned educators and industry experts, strives to empower students
                                with the knowledge and skills needed to thrive in their chosen fields. </li>
                        </ul>
