                     ...
                     <div class="row-fluid">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
								...
								<input name="uploaded_file"  class="input-file uniform_on" id="fileInput" type="file" required style="border-color:cornflowerblue">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="name" Placeholder="File Name"  class="input" required style="border-color:cornflowerblue">
                            </div>
                        </div>
                        <div class="control-group">
                          
                            <div class="controls">
                                <input type="text" name="desc" Placeholder="Description"  class="input" required style="border-color:cornflowerblue">
                            </div>
                        </div>
