                                ...
                                <div class="span12">
									...
									<a href="teacher_quiz.php" class="btn btn-info"><i class="icon-arrow-left"></i> Back</a>
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text" name="Exam_title" id="inputEmail" placeholder="Exam Title" required style="border-color:cornflowerblue">
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="inputPassword">Exam Description</label>
											<div class="controls">
											<input type="text" class="span8" name="description" id="inputPassword" placeholder="Exam Description" required style="border-color:cornflowerblue">
											</div>
										</div>										
										<div class="control-group">
										<div class="controls">										
