                            ...
                            <div class="block-content collapse in">
								...
								<!--
									...
									-->	
                                          ...
                                          <div class="controls">
                                            <select name="department"  class="" required style="border-color:cornflowerblue">
                                             	<option></option>
											<?php
										...
										<div class="control-group">
                                          <div class="controls">
                                            <input class="input focused" name="firstname" id="focusedInput" type="text" placeholder = "Firstname" style="border-color:cornflowerblue">
                                          </div>
                                        </div>
										
										<div class="control-group">
                                          <div class="controls">
                                            <input class="input focused" name="lastname" id="focusedInput" type="text" placeholder = "Lastname" style="border-color:cornflowerblue">
                                          </div>
                                        </div>
