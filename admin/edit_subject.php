		                        ...
		                        <div id="" class="block">
									...
									?>
										...
										mysqli_query($conn,"update subject set subject_code = '$subject_code' ,
																		...
																		where subject_id = '$get_id' ")or die(mysqli_error($conn));
																		
										mysqli_query($conn,"insert into activity_log (date,username,action) values(NOW(),'$user_username','Edit Subject $subject_code')")or die(mysqli_error($conn));
