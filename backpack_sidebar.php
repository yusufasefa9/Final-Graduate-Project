<div class="span3" id="sidebar">
		...
		<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
			...
			?>
			<li class="">
			<a href="student_message.php"><i class="icon-chevron-right"></i><i class="icon-envelope-alt"></i>&nbsp;Message</a></li>
			 <li class="active"><a href="backpack.php"><i class="icon-chevron-right"></i><i class="icon-suitcase"></i>&nbsp;Backpack</a></li>
			 
			 <li class=""><a href="view_single_result.php"><i class="icon-chevron-right"></i><i class="icon-suitcase"></i>&nbsp;view result</a></li>
		</ul>
