...
if(isset($_POST['signup'])){
    ...
    if(count($errors) === 0){
        ...
        $status = "notverified";
        $insert_data = "INSERT INTO student (name, email, password, code, status)
        ...
        if($data_check){
            ...
            $sender = "From: yeshinehabebaw@gmail.com";
...
if(isset($_POST['change-password'])){
    ...
    if($password !== $cpassword){
        ...
        $update_pass = "UPDATE student SET code = $code, password = '$pass' WHERE email = '$email'";
