...
--
-- 1. Alter student_assignment table to add foreign key constraint


-- 2. Alter student_class_quiz table to add foreign key constraint
...
ALTER TABLE subject ADD COLUMN student_id INT;
