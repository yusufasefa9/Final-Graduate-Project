                            ...
                            <div class="block-content collapse in">
								...
								<table cellpadding="0" cellspacing="0" border="0" class="table" id="">
                              		...
                              		<?php
										...
										// Check if $row1 is not null and if it has the 'grade' key before accessing it
										if(isset($row1) && isset($row1['grade'])){
											$grade = $row1['grade'];
											// Now you can use $grade safely
										} else {
											// Handle the case where $row1 is null or 'grade' key is not set
											$grade = ""; // Or any other default value you prefer
										}
