                            ...
                            <div class="block-content collapse in">
							    ...
							    <form class="form-horizontal" method="post">
								        <div class="control-group">
											...
											<div class="controls">
													<textarea name="question" id="ckeditor_full" required style="border-color:cornflowerblue"></textarea>
											</div>
										</div>
										<!-- <div class="control-group">
										...
										<div class="control-group">
											...
											<div class="controls">			
												<select id="qtype" name="question_tpye" required style="border-color:cornflowerblue">
													<option value="" ></option>
													<?php
