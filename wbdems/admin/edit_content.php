							...
							<!-- block -->
		                        <div class="block">
									...
									<a href="content.php"><i class="icon-arrow-left"></i> Back</a>
									   <?php
									   $query = mysqli_query($conn,"select * from content where content_id = '$get_id'")or die(mysqli_error($conn));
									   ...
									   <form class="form-horizontal" method="POST">
										...
										mysqli_query($conn,"update content set title = '$title' , content = '$content' where content_id = '$get_id'")or die(mysqli_error($conn));
										?>
										<script>
