	...
	<div class="row-fluid">
				      <!-- block -->
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="name" Placeholder="File Name"  class="input" style="border-color:cornflowerblue">
                            </div>
                        </div>
                        <div class="control-group">
                          
                            <div class="controls">
							<textarea id="assigntextare" placeholder="Description" name="desc" required style="border-color:cornflowerblue"></textarea>
