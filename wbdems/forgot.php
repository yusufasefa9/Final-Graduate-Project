...
if(isset($_REQUEST['pwdrst'])) {
    ...
    if($res > 0) {
        $message = '<div>
             ...
             <br>
             <p><button class="btn btn-primary"><a href="http://localhost/IMSP/passwordreset.php?secret='.base64_encode($email).'">Reset Password</a></button></p>
             <br>
...
<input type="submit" id="login" name="pwdrst" value="Send Password Reset Link" class="btn btn-success" />
       ...
       <p class="<?php echo $msgClass; ?>"><?php if(!empty($msg)){ echo $msg;
