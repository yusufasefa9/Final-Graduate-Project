        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
					...
					// Check if $read_row is not null and if it has the 'student_read' key before accessing it
					if(isset($read_row) && isset($read_row['student_read'])) {
						$yes = $read_row['student_read'];
						// Now you can safely use $yes
					} else {
						// Handle the case where $read_row is null or 'student_read' key is not set
						// For example, you can assign a default value to $yes
						$yes = ""; // Or any other default value you prefer
					}
