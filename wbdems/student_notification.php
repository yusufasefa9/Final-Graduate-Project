        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
					...
					if (is_array($read_row) && isset($read_row['student_read'])) {
						$yes = $read_row['student_read'];
					} else {
						// Handle the case when the key 'student_read' is not set in $read_row
						$yes = ""; // Or any default value you want to assign
					}
